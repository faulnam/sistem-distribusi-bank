        ...
        modalBody.innerHTML = `
            <div class="confirm-details">
                <div class="confirm-header">
                    ...
                    <span>${isOnline ? 'Transfer Online' : 'Transfer Overbooking'}</span>
                </div>
                ...
                <div class="confirm-row total">
                    <span class="confirm-label">Total Transfer</span>
                    <span class="confirm-value">${Utils.formatCurrency(transfer.jumlah)}</span>
                </div>
            </div>
        `;
